...
MUNICIPALITIES = {
    "愛知県": {
        ...
        "cities": [
            ...
            {"name": "知立市", "slug": "chiryu", "desc": "三河地域の交通の要衝。名鉄沿線の住宅開発や道路整備が活発。", "demand": "住宅団地、道路整備、区画整理", "distance": "名古屋から約40分"},
            {"name": "碧南市", "slug": "hekinan", "desc": "衣浦湾に面した臨海工業都市。工場施設や港湾設備の測量需要。", "demand": "臨海工業施設、港湾測量、農地整備", "distance": "名古屋から約45分"},
            {"name": "高浜市", "slug": "takahama", "desc": "三河湾沿岸の工業都市。瓦産業の跡地再開発や住宅開発が進行。", "demand": "跡地再開発、住宅造成、道路整備", "distance": "名古屋から約40分"},
            {"name": "知多市", "slug": "chita", "desc": "知多半島北部の工業都市。石油化学工場や物流施設の測量需要。", "demand": "工業施設、港湾整備、住宅開発", "distance": "名古屋から約30分"},
            {"name": "常滑市", "slug": "tokoname", "desc": "中部国際空港（セントレア）の立地都市。空港関連施設や周辺インフラの整備需要。", "demand": "空港関連施設、埋め立て測量、道路整備", "distance": "名古屋から約40分"},
            {"name": "江南市", "slug": "konan", "desc": "尾張北部の住宅都市。区画整理事業や農業用水路の整備需要。", "demand": "区画整理、農業基盤整備、道路建設", "distance": "名古屋から約25分"},
            {"name": "稲沢市", "slug": "inazawa", "desc": "尾張中部の農業都市。農業基盤整備と工業団地開発の需要。", "demand": "農地整備、工業団地、道路建設", "distance": "名古屋から約20分"},
            {"name": "清須市", "slug": "kiyosu", "desc": "名古屋西部の住宅都市。清洲城周辺の整備や宅地開発が進行。", "demand": "宅地造成、道路整備、公共施設", "distance": "名古屋から約15分"},
            {"name": "津島市", "slug": "tsushima", "desc": "尾張西部の歴史都市。日光川周辺の河川整備や住宅開発の需要。", "demand": "河川整備、住宅開発、道路建設", "distance": "名古屋から約25分"},
            {"name": "蒲郡市", "slug": "gamagori", "desc": "三河湾の観光・漁業都市。海岸保全施設や観光インフラの測量需要。", "demand": "海岸保全、港湾施設、観光インフラ", "distance": "名古屋から約60分"},
            {"name": "新城市", "slug": "shinshiro", "desc": "東三河山間部の都市。山間地のインフラ整備や太陽光発電用地の測量需要。", "demand": "山間部道路、太陽光発電用地、林道整備", "distance": "名古屋から約80分"},
            {"name": "武豊町", "slug": "taketoyo", "desc": "知多半島中央部の臨海工業都市。火力発電所や港湾施設の測量需要が高い。", "demand": "発電所施設、港湾測量、工業団地整備", "distance": "名古屋から約40分"},
        ]
    },
    "岐阜県": {
        "region_slug": "gifu",
