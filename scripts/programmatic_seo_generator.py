...
MUNICIPALITIES = {
    "愛知県": {
        ...
        "cities": [
            ...
            {"name": "あま市", "slug": "ama", "desc": "名古屋市西部に隣接する都市。住宅地と農地が混在し、区画整理や排水施設の整備需要が高い。", "demand": "区画整理、排水施設整備、宅地造成", "distance": "名古屋から約20分"},
            {"name": "犬山市", "slug": "inuyama", "desc": "国宝犬山城を擁する観光・住宅都市。丘陵地の開発や木曽川周辺のインフラ整備が進行。", "demand": "丘陵地造成、河川整備、観光施設建設", "distance": "名古屋から約35分"},
            {"name": "知立市", "slug": "chiryu", "desc": "名鉄知立駅の高架化事業が進む交通要衝。駅周辺再開発と連続立体交差事業の需要。", "demand": "駅前再開発、連続立体交差、道路整備", "distance": "名古屋から約30分"},
            {"name": "稲沢市", "slug": "inazawa", "desc": "尾張地域の住宅・農業都市。大規模物流施設の建設や幹線道路整備が活発。", "demand": "物流施設建設、幹線道路整備、農地転用", "distance": "名古屋から約20分"},
            {"name": "江南市", "slug": "konan", "desc": "尾張北部の住宅都市。木曽川沿いの堤防整備や住宅開発が進行。", "demand": "河川堤防整備、住宅開発、道路建設", "distance": "名古屋から約30分"},
            {"name": "日進市", "slug": "nisshin", "desc": "名古屋市東部のベッドタウン。人口増加に伴う宅地開発や学校施設建設が活発。", "demand": "宅地造成、学校施設、道路・上下水道整備", "distance": "名古屋から約25分"},
            {"name": "長久手市", "slug": "nagakute", "desc": "愛・地球博の開催地。リニモ沿線の開発やジブリパーク周辺のインフラ整備が進行。", "demand": "沿線開発、公園施設、住宅開発", "distance": "名古屋から約25分"},
            {"name": "みよし市", "slug": "miyoshi", "desc": "豊田市に隣接する住宅・工業都市。自動車関連工場や住宅団地の開発が活発。", "demand": "工場用地、住宅団地、道路整備", "distance": "名古屋から約35分"},
            {"name": "知多市", "slug": "chita", "desc": "知多半島北部の臨海工業都市。製油所や発電施設周辺のインフラ整備需要が高い。", "demand": "臨海工業施設、道路建設、住宅開発", "distance": "名古屋から約30分"},
            {"name": "常滑市", "slug": "tokoname", "desc": "中部国際空港セントレアの所在地。空港関連施設や臨海部の開発が継続。", "demand": "空港関連施設、臨海開発、道路整備", "distance": "名古屋から約40分"},
            {"name": "蒲郡市", "slug": "gamagori", "desc": "三河湾に面した観光・漁業都市。港湾施設整備や海岸保全事業の需要。", "demand": "港湾施設、海岸保全、観光インフラ", "distance": "名古屋から約60分"},
            {"name": "北名古屋市", "slug": "kitanagoya", "desc": "名古屋市北部に隣接する住宅都市。都市基盤整備や商業施設建設が進行。", "demand": "都市基盤整備、商業施設、道路建設", "distance": "名古屋から約15分"},
        ]
    },
    "岐阜県": {
        "region_slug": "gifu",
